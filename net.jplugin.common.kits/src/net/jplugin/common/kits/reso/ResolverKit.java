 ...
 * {@link #find(org.apache.ibatis.io.ResolverKit.Test, String)} ()} method and supplying
...
public class ResolverKit<T> {
   ...
   */
  public ResolverKit<T> find(Test test, String packageName) {
   ...
   *        classes, e.g. {@code net.sourceforge.stripes}
   */
  public ResolverKit<T> find(String packageName, Test test) {
