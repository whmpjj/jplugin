...
public class ExtensionMybatisDasHelper {
	...
	public static void addMappingExtension(AbstractBasicPlugin plugin,Class mappingIntf){
//		plugin.addExtension(Extension.create(Plugin.EP_MYBATIS_MAPPER, String.class,new String[][]{{"value",mappingIntf.getName()}}));
	...
	public static void addConfigExtension(AbstractBasicPlugin plugin,String resource){
		addConfigExtension(plugin,DataSourceFactory.DATABASE_DSKEY, resource);
	}
	
	public static void addMappingExtension(AbstractBasicPlugin plugin,String resource){
//		plugin.addExtension(Extension.create(Plugin.EP_MYBATIS_MAPPER, String.class,new String[][]{{"value",resource}}));
	...
	public static void addMappingExtension(AbstractBasicPlugin plugin,String dataSource,Class mappingIntf){
//		plugin.addExtension(Extension.create(Plugin.EP_MYBATIS_MAPPER, dataSource,String.class,new String[][]{{"value",mappingIntf.getName()}}));
	...
	public static void addConfigExtension(AbstractBasicPlugin plugin,String dataSource,String resource){
	...
	public static void addMappingExtension(AbstractBasicPlugin plugin,String dataSource,String resource){
	...
	public static void addInctprorExtension(AbstractBasicPlugin plugin,Class inceptorClass){
//		plugin.addExtension(Extension.create(Plugin.EP_MYBATIS_INCEPT, inceptorClass));
	...
	public static void addInctprorExtension(AbstractBasicPlugin plugin,String dataSource,Class inceptorClass){
	 ...
	 */
	public static void autoBindMapperExtension(AbstractBasicPlugin p, String pkgPath) {
	 ...
	 */
	@Deprecated
	public static void autoAddMappingExtension(AbstractBasicPlugin p, String dataSource,String pkgPath) {
